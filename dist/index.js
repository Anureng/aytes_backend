...
const user_2 = __importDefault(require("./graphql/schema/user"));
const user_3 = require("./graphql/resolver/user");
...
app.post("/create-project", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const existingProject = yield project_1.default.findOne({ email });
        if (!existingProject) {
